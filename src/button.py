...
class RobotControllerUI(QWidget):
    ...
    def initUI(self):   
        ...
        grid.addWidget(QLabel('modify shoulder x left, y forward, z up'),13,0)
        

        #guozi:add left & right shoulder controller
        grid.addLayout(self.create_shoulder_layout(self.left_shoulder_name, self.left_shoulder), 14, 0)
        
        grid.addLayout(self.create_shoulder_layout(self.right_shoulder_name, self.right_shoulder), 14, 1)
