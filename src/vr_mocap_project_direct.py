...
from vr_mocap_data_wrapper_direct import VRMocapDataWrapperDirect
...
class VRMocapManager:
    def __init__(self):
        ...
        # start vuer website
        self.data_provider = VRMocapDataWrapperDirect()
    ...
    def run(self):
        ...
        while not rospy.is_shutdown():
            ...
            self.data_provider.set_data()
            data = self.data_provider.get_data()

            tf_hand_left, tf_hand_right, joint_hand_left, joint_hand_right, head_data, left_data, right_data = self.mocap2robot.process(
                data)
